...
export default function ClinicProfilePageContainer({ clinic }) {
  ...
  return (
    <>
      ...
      <DirectTabs />
      <ExtraLargePageContainer className="!relative flex flex-col gap-8 mt-[20px] lg:flex-row  flex-col-reverse">
        <div className="shadow-lg flex-1 rounded-2xl p-1 sm:p-5">
          <Overview />
