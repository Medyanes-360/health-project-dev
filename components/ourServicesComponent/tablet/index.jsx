...
const ServicesCarousel = dynamic(() => import("./TabletServicesCarousel"));
...
const OurServicesMobile = () => {
  return (
    <div className="xl:container mx-auto services-section px-4 py-8 mb-10 mt-8">
      {/* Başlık Bölümü */}
      <div className="mb-4">
        <p className="text-[#52B8AB] font-poppins font-medium text-[14px] leading-[21px] text-center">
          OUR SERVICES
        </p>
        <h2 className="text-[#062126] font-poppins font-medium text-[18px] leading-[27px] mt-2 text-center">
