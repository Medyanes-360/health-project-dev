...
export default function FeatureCard({ active, ...props }) {
  ...
  return (
    <div className="group hover:shadow-xl hover:scale-105 lg:hover:bg-inherit hover:bg-primary-light  hover:border-primary transition-all duration-200 cursor-pointer rounded-lg flex justify-start  items-center sm:p-2 p-1  border lg:border-none">
